...
const PropertyDetailsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (property && propertyId) {
      const currentMockProperty = MOCK_PROPERTIES.find(p => p.id === propertyId);
      if (JSON.stringify(property) !== JSON.stringify(currentMockProperty)) {
        setProperty(currentMockProperty || null);
      }
    }
  }, [MOCK_PROPERTIES, property, propertyId]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-1 bg-light-gray p-6 rounded-lg shadow-md flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              ...
              <PropertySpecItem icon={<CalendarIcon />} label={T.listedOn} value={new Date(property.dateAdded).toLocaleDateString(language === 'ar' ? 'ar-EG' : 'en-US')} />
            </div>
