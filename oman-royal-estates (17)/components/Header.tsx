...
const Header: React.FC = () => {
  ...
  const navLinkClass = ({ isActive }: { isActive: boolean }) =>
    `px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150 ease-in-out ${
      isActive ? 'text-gold-accent font-semibold' : 'text-gray-200 hover:text-gold-accent'
    }`;
  ...
  const languageButtonClass = "text-gray-200 hover:text-gold-accent px-3 py-2 rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-gold-accent";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-center space-x-4"> {/* Changed items-baseline to items-center */}
                ...
                <div className="relative" ref={companyDropdownRef}>
                  <button
                    ...
                    className={`px-3 py-2 rounded-md text-sm font-medium flex items-center transition-colors duration-150 ease-in-out ${isCompanyDropdownOpen ? 'text-gold-accent font-semibold' : 'text-gray-200 hover:text-gold-accent'}`}
                  >
              ...
              {user ? (
                ...
                <div className="ml-4 flex items-center md:ml-6 space-x-2">
                  <button
                    ...
                    className="text-gray-200 hover:text-gold-accent px-3 py-2 rounded-md text-sm font-medium transition-colors"
                  >
                    {T.login}
                  </button>
                  <button
